...
// Mock toast
vi.mock('@/components/ui/toast', () => ({ useToast: () => ({ showSuccess: vi.fn(), showError: vi.fn() }) }));

// Mock motion and DismissableLayer
vi.mock('motion/react', () => ({ motion: { div: (props: any) => <div {...props} /> } }));
vi.mock('@radix-ui/react-dismissable-layer', () => ({ DismissableLayer: ({ children }: any) => <>{children}</> }));

// Mock select components
vi.mock('@/components/ui/select', () => ({
  Select: () => <div data-testid="select-placeholder" />, SelectTrigger: () => <div />, SelectValue: () => <div />,
